...
const textNodes = [
  ...
  {
    id: 20,
    text: `"Тобі треба повернутися до панелі керування і натиснути на червону кнопку після того як загориться жовта лампа тиснеш на зелену та тягнеш кермо до низу"`,
    options: [
      {
        text: 'Записати',
        nextText: 21,
  ...
  {
    id: 23,
    text: `Ти дістаєш блокнот у котрому написано (Натиснути на червону кнопку потім на жовту та потягнути кермо до низу)`,
    options: [
      {
        text: 'Натиснути на червону кнопку',
        nextText: 60,
      },
      {
        text: 'Натиснути на зелену кнопку',
        nextText: 26,
      },
      {
        text: 'Тягнути кермо до низу',
        nextText: 26,
      },
    ]
  },
  {
    id: 60,
    text: `У кабіні почався сильний вітер та твій запис улетів до вентиляції. - Нічого страшного здається я усе запам'ятав. Ти повертаешь голову ліворуч та бачиш як горить жовта лампа.`,
    options: [
      {
        text: 'Тягнути кермо до низу',
        nextText: 26,
      ...
      {
        text: 'Знов натиснути на червону',
        nextText: 26,
      },
    ]
  },
  {
    id: 61,
    text: `Здається у тебе все виходить!!`,
    options: [
      {
        text: 'Тягнути кермо до низу',
        nextText: 25,
      ...
      {
        text: 'Знов натиснути на зелену кнопку',
        nextText: 26,
      },
      {
        text: 'Тягнути кермо до гори',
        nextText: 26,
      },
    ]
  },
  {
    id: 62,
    text: `Ти повертаешь голову ліворуч та бачиш як горить жовта лампа.`,
    options: [
      {
        text: 'Тягнути кермо до низу',
        nextText: 26,
  ...
  {
    id: 33,
    text: `Ти згадуєш порядок необхідих дій`,
    options: [
      {
        text: 'Натиснути на червону кнопку',
        nextText: 62,
  ...
  {
    id: 65,
    text: `Ти повертаєшь голову ліворуч та бачиш як горить жовта лампа`,
    options: [
      {
        text: 'Натиснути на жовту кнопку',
        nextText: 34,
      },
      {
        text: 'Натиснути на зелену кнопку',
  ...
  {
    id: 70,
    text: ` Повернувши голову ліворуч ти побачив як загорілась жовта лампа. Здається твої м'язи пам'ятають що робити!!! Або тобі лише звезло...`,
    options: [
      {
        text: 'Натиснути на зелену кнопку',
        nextText: 51,
      ...
      {
        text: 'Знов натиснути на червону кнопку',
        nextText: 71,
      },
      {
        text: 'Тягнути кермо до гори',
  ...
  {
    id: 58,
    text: `Здається в тебе на така гарна пам'ять як тобі здавалось`,
    options: [
      {
        text: 'Натиснути на червону кнопку',
        nextText: 62,
